...
export default function EditTravelStopModal({ searchQuery, isModalVisible, setSearchQuery, onClose, onSelect }: Props) {
                            ...
                            <FlatList
                                ...
                                renderItem={({ item }) => (
                                    <TouchableOpacity
                                        ...
                                        {
                                            item.vehicle_type?.name ? <Icon name={item.vehicle_type.icon_id.name.toLocaleLowerCase()} size={16}></Icon> : <Icon name="train" size={16}></Icon>
                                        }
